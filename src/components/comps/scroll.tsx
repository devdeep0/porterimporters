      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/frontpage/bmw-d942a3zxd8i3uqc8.jpg"
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          Our team of automotive experts is here to guide you through every step, helping you choose the right vehicle that fits your needs and budget.          </p>
          <div className="mb-8">
